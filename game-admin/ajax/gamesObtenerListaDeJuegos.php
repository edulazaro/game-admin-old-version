...
function gamesObtenerListaDeJuegos(){
	...
	$plataforma=esc_sql($_POST['plataforma']); $letra=esc_sql($_POST['letra']); $origen=esc_sql($_POST['letra']);
	...
	<?php
	if($origen) {
		if($origen=='games_newgameexpansion'){ echo('Seleccionar juego original'); }
